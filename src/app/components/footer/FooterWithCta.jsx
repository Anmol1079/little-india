    ...
    <footer className="relative w-full bg-[#070707] text-[#FAF8F5] overflow-hidden font-sans border-t-2 border-[#c5a880]/20">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-6 pt-16 pb-16">
        ...
        >
          ...
          <motion.h2
            variants={childVariants}
            className="font-title font-black text-[36px] sm:text-[60px] md:text-[60px] text-white uppercase leading-none tw-tight mb-4"
          >
            WE’RE READY
          </motion.h2>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-12 gap-y-10 gap-x-6 lg:gap-12 pt-16 pb-4">
        ...
        <div className="col-span-6 lg:col-span-2">
          <h3 className="text-xs font-black tracking-[0.2em] text-[#e94222] uppercase mb-6">
            Explore
          </h3>
          ...
          <div className="flex flex-col gap-5 text-sm font-medium text-neutral-400">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[#E94222] shrink-0">
                <svg className="w-4 h-4 fill-none stroke-current stroke-2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.387a12.035 12.035 0 0 1-7.108-7.108c-.145-.44.02-.927.387-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                </svg>
              </span>
              <a
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2.5">
                {[
                  ...
                  { label: 'yt', path: 'M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2a29 29 0 0 0 1.94-2c1.72-.46 8.6-.46 8.6-.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25v-.17a29 29 0 0 0-.46-5.33z M10 15V8.5l6 3.25L10 15z' }
                ].map((icon) => (
                  <a
                    key={icon.label}
                    href="#"
      ...
      {/* FOOTER BOTTOM BAR */}
      <div className="border-t border-neutral-900/60 mt-8 pt-8 max-w-7xl mx-auto px-6 md:px-12 pb-6 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10 text-xs font-semibold text-neutral-500 uppercase twst">
