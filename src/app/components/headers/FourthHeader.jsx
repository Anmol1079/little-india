    ...
    return (
        ...
        >
            ...
            >
                ...
                <nav className="hidden xl:flex items-center gap-5 lg:gap-6 text-[12px] lg:text-[13px] font-extrabold tracking-widest text-stone-800 uppercase">
                    ...
                    >
                        ...
                        {activeDropdown === 'menu' && (
                            <div className="absolute left-0 mt-3 w-56 bg-white border border-stone-200/60 rounded-xl py-2 shadow-xl animate-fadeIn">
                                <Link href="#lunch" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    LUNCH SPECIALS
                                </Link>
                                <Link href="#dinner" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    DINNER MENU
                                </Link>
                                <Link href="#drinks" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    WINE & SPIRITS
                                </Link>
                            </div>
                        )}
                    ...
                    >
                        ...
                        {activeDropdown === 'services' && (
                            <div className="absolute left-0 mt-3 w-56 bg-white border border-stone-200/60 rounded-xl py-2 shadow-xl animate-fadeIn">
                                <Link href="#catering" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    CATERING SERVICES
                                </Link>
                                <Link href="#events" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    PRIVATE EVENTS
                                </Link>
                                <Link href="#delivery" onClick={() => setActiveDropdown(null)} className="block px-5 py-2.5 text-[11px] font-bold tracking-widest text-stone-700 hover:text-[#E75B44] hover:bg-stone-50 transition-all uppercase">
                                    HOME DELIVERY
                                </Link>
                            </div>
                        )}
                ...
                <div className="hidden xl:flex items-center gap-6 shrink-0">
                    ...
                    {/* <button className="relative p-1.5 text-stone-900 hover:text-[#E75B44] transition-colors focus:outline-none" aria-label="Open cart">
                    ...
                    <Link
                        href="#contact"
                        className="bg-[#E75B44] hover:bg-[#d14b35] text-white text-xs md:text-sm font-bold px-6 py-2.5 rounded-full transition-all duration-300 shadow-sm shadow-[#E75B44]/10"
                    >
                        Contact Us
                    </Link>
                </div>
                ...
                <div className="flex xl:hidden items-center gap-4">
                    ...
                    <button
                        ...
                        className="p-1.5 text-stone-900 hover:text-[#E75B44] transition-colors focus:outline-none"
            ...
            >
                <div className="p-6 flex flex-col gap-5 text-sm font-bold tracking-widest uppercase text-stone-800">
                    <Link
                        href="#home"
                    ...
                    <div className="border-b border-stone-100 pb-2">
                        ...
                        {activeDropdown === 'menu' && (
                            <div className="flex flex-col gap-3 pl-4 pt-3 text-xs text-stone-600 font-semibold tracking-wider">
                    ...
                    <Link
                        href="#contact"
                        onClick={() => setMobileMenuOpen(false)}
                        className="w-full text-center bg-[#E75B44] text-white text-xs font-bold tracking-wider py-3.5 rounded-full hover:bg-[#d14b35] transition-all duration-300 shadow-sm uppercase focus:outline-none mt-2"
                    >
                        Contact Us
                    </Link>
                </div>
